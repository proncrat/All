...
export async function seed(knex) {
  ...
  await knex('photos').insert([
    ...
    },
    {
      ...
      name: 'Jane',
      describe: 'Claude make me a description',
      url: '/images/heres-a-2k-jane-doe-wallpaper-for-you-guys-v0-l0cux9p736md1.webp',
      thumburl:
        '/images/heres-a-2k-jane-doe-wallpaper-for-you-guys-v0-l0cux9p736md1.webp',
      author_id: 1,
    },
    {
      id: 5,
    ...
    },
    {
      ...
      name: 'Holy',
      describe: 'Claude make me a description',
      url: '/images/holy.jfif',
      thumburl: '/images/holy.jfif',
      author_id: 1,
    },
    {
      id: 9,
      name: 'Goat',
      describe: 'Claude make me a description',
      url: '/images/goat.jfif',
      thumburl: '/images/goat.jfif',
      author_id: 1,
    },
  ])
}
